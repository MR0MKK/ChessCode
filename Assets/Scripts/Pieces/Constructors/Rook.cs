...
// Các hằng số và phương thức cần cho phép "Rook" di chuyển
public class Rook
{
    ...
    int GetPositionValueWhite()
    {
        ...
        return -500 + whiteValue[(int)position.y - 1, (int)position.x - 1];
    }
    ...
    int GetPositionValueBlack()
    {
        ...
        return 500 + blackValue[(int)position.y - 1, (int)position.x - 1];
    }
    #endregion
}